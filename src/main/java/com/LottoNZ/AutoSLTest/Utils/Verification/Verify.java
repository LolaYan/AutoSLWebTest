...
public class Verify {
	...
	private static void addToErrorBuffer(AssertionError e) {
		...
		try {
			...
			throw new RuntimeException(
					"Please let TestNG know about "
							+ TestMethodListener.class.getName()
	...
	static public void verifyEquals(Collection<?> actual,
	...
	static public void verifyEquals(double actual, double expected,
	...
	static public void verifyEquals(String actual, String expected,
			String message) {
		try {
			System.out.println("debug verifyEquals......");
			Assert.assertEquals(actual, expected, message);
		} catch (AssertionError e) {
			addToErrorBuffer(e);
		}
	...
	static public void verifyNotEquals(double actual1, double actual2,
			double delta) {
		try {
	...
	static public void verifyNotEquals(float actual1, float actual2,
