...
public class HttpUtils {
	public static void activateEmail(String activationId) {
		String urlStr = "http://192.168.100.72:8081/api/core/v1/accounts/status";
		String reqParams = getEmailActivationRequestBody(activationId);
		sendHttpPutReq(urlStr, reqParams);
	}
	...
	public static BufferedReader sendHttpGetReq(String urlStr, String reqParams) {
		try {
	...
	public static BufferedReader sendHttpPostReq(String urlStr, String reqParams) {
	...
	public static BufferedReader sendHttpPutReq(String urlStr, String reqParams) {
